Shader "Sprites/OutlineReplace"
{//https://nielson.io/2016/04/2d-sprite-outlines-in-unity/
    // Ryan Nielson
	//Replaces black outline NES sprites with a new color,
	//DOES NOT ADD OUTLINE it replaces existing one, doesn't work on non-NES-spritesheets.
	Properties
	{
